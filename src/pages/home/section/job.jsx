  ...
  return (
    <div>
      <div className="p-12">
        ...
        <div className="w-full p-4 space-x-4 carousel carousel-center rounded-box bg-lime-50">
          {dataJob !== null &&
            dataJob.map((res) => {
              return (
                <>
                  <div className="p-2 bg-white shadow-md card carousel-item h-52">
                    <div className="flex flex-row space-x-2">
                      <div className="w-12 h-12">
                        <img src={res.company_image_url} alt="card" />
                      </div>
                      <div className="flex flex-col w-3/4">
                        <h1 className="text-base font-bold">{res.title}</h1>
                        <h1 className="text-base font-medium">
                          {res.company_name}
                        </h1>
                      </div>
                    </div>
                    <div className="p-1 m-1 border-t-2">
                      <div className="flex items-center">
                        <img
                          ...
                          className="w-5 h-5"
                        />
                        <span className="ml-2">{res.company_city}</span>
                      </div>
                      <div className="flex items-center">
                        <img
                      ...
                      <div className="flex items-center">
                        <img
                          ...
                          className="w-5 h-5"
                        />
                        <span className="ml-2">{res.job_tenure}</span>
                      </div>
                    </div>
                    <div>
                      <Link
